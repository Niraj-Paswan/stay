      ...
      <div class="container mx-auto p-4">
        ...
        <div class="flex flex-wrap lg:flex-nowrap gap-6">
          ...
          <div class="flex-1" id="property_gallery">
            ...
            <div
              class="bg-white p-4 border-[1.5px] border-gray-300 rounded-lg h-[100%]"
              id="image_gallery"
            >
              <!-- Main Image -->
              ...
              <div class="grid grid-cols-3 gap-4 mt-4" id="thumbnails">
                <div
                  class="relative w-full h-44 rounded-lg overflow-hidden border-[1.5px] border-gray-300"
                >
                
                  <img
                    src="<?= $property['kitchen'] ?>"
                    alt="Thumbnail"
                    class="w-full h-full object-cover"
                    name="thumbnail_1"
                    id="thumbnail_1"
                  />
                  <div
                    class="absolute bottom-0 w-full bg-gray-200 p-2 text-center text-sm font-medium"
                  >
                    Kitchen
                  </div>
                </div>
              ...
              <h2
                class="text-2xl font-semibold text-gray-800 mt-6 flex flex-row justify-between"
                id="property_title_container"
              >
                <span name="property_title" id="property_title"
              ...
              <div
                class="flex flex-row items-center justify-start mr-12"
                id="property_location_container"
              >
                <p class="text-gray-600 font-normal text-sm">
                  <i class="fa-regular fa-location-dot text-sm"></i>
                  <span name="property_location" id="property_location"
          ...
          <!-- Right Section -->
          <div
            class="w-full h-[100%] lg:w-1/3 bg-white p-4 rounded-lg border-[1.5px] border-gray-300 shadow-sm"
            data-property-id="1"
            data-property-name="Suddha Apartment"
            data-rent-price="15000"
            data-rent-duration="month"
            data-verified="1"
          >
            <h2
              class="text-lg font-semibold text-gray-800 mt-4 flex flex-row justify-between mb-2"
            >
              <?= $property['property_name'] ?>
              <div
                class="text-sm font-medium bg-green-200 p-1 px-2 rounded-sm text-black"
                data-verified="1"
              >
                <i class="fa-light fa-badge-check mr-2"></i>Verified
              </div>
            </h2>
            ...
            <div class="mt-6">
              ...
              <div class="collapsible-item border-t border-gray-300">
                <button
                  type="button"
                  class="toggle-button w-full flex justify-between items-center py-4 text-left"
                  onclick="toggleContent('feature1', this.querySelector('.rotate-icon'))"
                  data-feature-id="1"
                >
                  <span
                    class="flex items-center text-sm font-medium text-gray-800 gap-4"
                  >
                    <div
                      class="icon-wrapper w-9 h-9 bg-blue-200 bg-opacity-25 rounded-full flex justify-center items-center"
                    >
                      <i
                        class="fa-light fa-calendar-check text-[16px] text-for"
                      ></i>
                    </div>
                    Instant Booking
                  </span>
                  <i
                    class="rotate-icon fa-solid fa-caret-down mr-4 text-sm text-gray-500"
                  ></i>
                </button>
                <div
                  id="feature1"
                  class="hidden px-4 py-2 text-gray-600 text-sm"
              ...
              <div class="collapsible-item border-t border-gray-300">
                <button
                  type="button"
                  class="toggle-button w-full flex justify-between items-center py-4 text-left"
                  onclick="toggleContent('feature2', this.querySelector('.rotate-icon'))"
                  data-feature-id="2"
                >
                  <span
                    class="flex items-center text-sm font-medium text-gray-800 gap-4"
                  >
                    ...
                    >
                      <i
                        class="fa-light fa-hand-holding-dollar text-[16px] text-for"
                      ></i>
                    </div>
              ...
              <div class="collapsible-item border-t border-gray-300">
                <button
                  type="button"
                  class="toggle-button w-full flex justify-between items-center py-4 text-left"
                  onclick="toggleContent('feature3', this.querySelector('.rotate-icon'))"
                  data-feature-id="3"
                >
                  <span
                    class="flex items-center text-sm font-medium text-gray-800 gap-4"
                  >
                    ...
                    >
                      <i
                        class="fa-light fa-circle-check text-[16px] text-for"
                      ></i>
                    </div>
                    Verified Listings
                  </span>
              ...
              <div class="collapsible-item border-t border-gray-300">
                <button
                  type="button"
                  class="toggle-button w-full flex justify-between items-center py-4 text-left"
                  onclick="toggleContent('feature4', this.querySelector('.rotate-icon'))"
                  data-feature-id="4"
                >
                  <span
                    class="flex items-center text-sm font-medium text-gray-800 gap-4"
              ...
              <div class="collapsible-item border-t border-gray-300">
                <button
                  type="button"
                  class="toggle-button w-full flex justify-between items-center py-4 text-left"
                  onclick="toggleContent('feature5', this.querySelector('.rotate-icon'))"
                  data-feature-id="5"
                >
                  <span
                    class="flex items-center text-sm font-medium text-gray-800 gap-4"
        ...
        <div
          class="sm:w-full lg:w-[100%] bg-white border border-gray-300 rounded-lg mt-4"
          data-property-id="1"
        >
          <!-- Section Title -->
          ...
          <div class="p-4">
            ...
            <p
              class="text-sm font-normal text-gray-700 mb-4 leading-relaxed"
        ...
        <!-- Room Amenties -->
        <div
          class="sm:w-full lg:w-[100%] h-[50%] mt-4 bg-white border-[1.5px] border-gray-300 rounded-lg"
          data-room-id="101"
        >
          <h2
            class="text-lg lg:text-[16px] font-medium py-2 ml-4"
            data-section="room-includes"
          >
            Room Includes
            <span
              class="ml-2 text-[14px] font-normal bg-green-600 text-white rounded-full px-3 py-1"
              >Amenities</span
            >
          </h2>
          ...
          <div
            class="flex flex-row justify-between py-2 text-gray-600 mr-12"
            data-bills-included="true"
          >
            <h2
              class="font-medium text-sm lg:text-[15px] py-2 ml-4"
              data-item="bills-included"
            >
              Bills included
            </h2>
            <div
              class="flex justify-center items-center flex-row gap-2"
              data-item-id="water"
            >
          ...
          <div
            class="flex flex-row justify-between py-2 text-gray-600 mr-12"
            data-common-amenities="true"
          >
            <h2
              class="font-medium text-sm lg:text-[15px] py-2 ml-4"
              data-item="common-amenities"
            >
              Common Amenities
            </h2>
            <div
              class="flex justify-center items-center flex-row gap-2 mr-0 lg:mr-12"
              data-item-id="parking"
            >
        ...
        <!-- Payment Policy -->
        <div
          class="sm:w-full lg:w-[100%] h-[50%] bg-white border-[1.5px] border-gray-300 rounded-lg mt-4"
          data-policy-id="101"
        >
          ...
          >
            ...
            <!-- Dropdown Icon -->
            <i
              class="fa-solid fa-caret-down ml-auto text-gray-500"
              id="dropdown-icon"
              data-toggle="true"
            ></i>
          </div>
          ...
          <div class="accordion-content hidden" data-accordion-content="true">
            ...
            <div
              class="flex flex-col justify-start items-start pt-1 border-b border-gray-300 hover:bg-gray-100"
              data-policy-id="deposit"
            >
              <div class="flex flex-row justify-center items-center gap-2">
                <i
                  class="fa-regular fa-circle-check text-green-600 text-xl ml-4"
                  data-icon="checkmark"
                ></i>
                <div class="flex flex-col justify-start items-start">
                  <h2
                    class="text-[16px] font-medium ml-2"
                    data-policy-name="booking-deposit"
                  >
                    Booking Deposit
                  </h2>
                  <p
                    class="text-sm font-light ml-2 text-gray-500 mb-2"
                    data-policy-description="deposit"
                  >
                    This property requires a booking deposit of
                    <span
                      class="font-medium text-gray-600"
                      data-deposit-amount="25%"
                      >25%</span
                    >
                    of the
            ...
            >
              <div class="flex flex-row justify-center items-center gap-2">
                ...
                <div class="flex flex-col justify-start items-start">
                  <h2
                    class="text-[16px] font-medium ml-2"
                    data-policy-name="mode-of-payment"
                  >
                    Mode of Payment
                  </h2>
                  <p
                    class="text-sm font-light ml-2 text-gray-500 mb-2"
                    data-policy-description="mode"
                  >
                    Payment via
                    <span class="font-medium text-gray-600"
                      >easy transaction</span
                    >
                    modes.
                  </p>
                </div>
            ...
            <div
              class="flex flex-col justify-start items-start pt-1 hover:bg-gray-100"
              data-policy-id="negotiable-rent"
            >
              <div class="flex flex-row justify-center items-center gap-2">
                <i
                  class="fa-regular fa-circle-check text-green-600 text-xl ml-4"
                ...
                <div class="flex flex-col justify-start items-start">
                  <h2
                    class="text-[16px] font-medium ml-2"
                    data-policy-name="negotiable-rent"
                  >
                    Negotiable Rent
                  </h2>
                  <p
                    class="text-sm font-light ml-2 text-gray-500 mb-2"
                    data-policy-description="rent-negotiable"
                  >
                    The amount can be
        ...
        >
          ...
          <!-- Dropdown Content (Initially hidden) -->
          <div
            class="accordion-content-cancellation hidden"
            ...
            >
              <div class="flex flex-row justify-center items-center gap-2">
                ...
                <div class="flex flex-col justify-start items-start">
                  <h2
                    class="text-[16px] font-medium ml-2"
                    data-policy-name="refund"
                  >
                    Refund
                  </h2>
                  <p
                    class="text-sm font-light ml-2 text-gray-500 mb-2"
                    data-policy-description="refund"
                  >
                    The remaining
                    <span
                      class="font-medium text-gray-600"
                      data-refund-amount="2%"
                      >2% will be charged</span
                    >
            ...
            >
              <div class="flex flex-row justify-center items-center gap-2">
                ...
                <div class="flex flex-col justify-start items-start">
                  <h2
                    class="text-[16px] font-medium ml-2"
                    data-policy-name="cancellation-payment"
                  >
                    Cancellation Payment
                  </h2>
                  <p
                    class="text-sm font-light ml-2 text-gray-500 mb-2"
                    data-policy-description="payment"
                  >
                    Payment will be transferred to the
                    <span
                      class="font-medium text-gray-600"
                      data-payment-duration="2-days"
                      >account within 2 days</span
                    >
        ...
        >
          <!-- Section Title -->
          <h2
            class="font-medium text-[16px] py-3 ml-4"
            data-title="locations-and-nearby"
          >
          ...
          <!-- Embedded Map (iframe) -->
          <iframe
            class="w-full h-[450px] border-gray-300 rounded-md p-4"
            src="../bookings/map_index.html"
            data-map="location-map"
            data-location-name="goa"
            data-latitude="15.2993"
            data-longitude="74.124"
            title="Location Map"
          ></iframe>
        </div>
      </div>
      ...
      <div class="mx-auto w-full max-w-screen-xl p-4 py-6 lg:py-8">
        <div class="md:flex md:justify-between">
          <div class="mb-6 md:mb-0 ml-14 md:ml-0 lg:ml-0">
            <a
              href="#"
              id="brands"
              class="font-Nrj-fonts font-semibold text-md flex items-center ml-2"
            >
              <img
                class="max-w-10 max-h-44 ml-5"
          ...
          <div class="grid grid-cols-2 gap-8 sm:gap-6 sm:grid-cols-3">
            <div>
              <h2
                class="mb-6 text-sm font-semibold text-for uppercase dark:text-white"
              >
                Resources
              </h2>
        ...
        <div class="sm:flex sm:items-center sm:justify-between">
          <span class="text-sm text-white sm:text-center dark:text-gray-400"
            >© 2025 <a href="#" class="hover:underline">StayEase™</a>. All
            Rights Reserved.
          </span>
          <div class="flex mt-4 sm:justify-center sm:mt-0">
            ...
            <a
              href="#"
              class="text-white hover:text-for dark:hover:text-white ms-5"
            >
              <svg
                class="w-4 h-4"
                aria-hidden="true"
            ...
            <a
              href="https://github.com/Niraj-Paswan/stay"
              class="text-white hover:text-for dark:hover:text-white ms-5"
            >
              <svg
                class="w-4 h-4"
