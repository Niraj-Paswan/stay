...
<body class="bg-gray-100 flex items-center justify-center min-h-screen font-Nrj-fonts">
  <div class="bg-white p-8 rounded-lg shadow-lg w-96 border-[0.5px] border-gray-300">
      ...
      <form action="login.php" method="POST">
        <div class="mb-4">
          ...
          <?php if (!empty($email_error)): ?>
            <p class="text-red-500 text-sm mt-2 font-Nrj-fonts"><?php echo $email_error; ?></p>
          <?php endif; ?>
        </div>
        ...
        <div class="mb-4">
          ...
          <?php if (!empty($password_error)): ?>
            <p class="text-red-500 text-sm mt-2 font-Nrj-fonts"><?php echo $password_error; ?></p>
          <?php endif; ?>
    ...
    <div class="justify-center items-center flex mt-4">
      <a href="adminlogin.html" class="font-Nrj-fonts text-sm hover:text-for hover:underline">
        Are you Admin?
      </a>
    </div>
  </div>
