...
/* Container for the icon to position it properly */
      .icon-container {
        position: absolute;
        left: -24px; /* Adjust this value to move the icon over the line */
        top: 50%; /* Center it vertically */
        transform: translateY(-50%);
        width: 36px; /* Width of the icon container */
        height: 36px; /* Height of the icon container */
  ...
  <body>
    <!-- Navbar -->
    <nav class="mt-2 h-16 border sm:border-[0.5px] flex bg-transparent justify-between items-center rounded-full w-[95%] absolute top-0 left-1/2 transform -translate-x-1/2 z-10 backdrop-blur-lg bg-white/10">
      ...
      <div id="nav-menu" class="hidden lg:flex gap-16">
        <a
          class="font-Nrj-fonts text-black text-md font-semibold group inline-block text-center relative"
          href="#"
          >Home
          <hr
        ...
        <a
          class="font-Nrj-fonts text-white text-md font-semibold group inline-block text-center relative"
          href="#"
          >Property
          <hr
        ...
        <a
          class="font-Nrj-fonts text-md text-white font-semibold group inline-block text-center relative"
          href="#"
          >Near By
          <hr
            class="opacity-0 group-hover:opacity-100 w-[80%] h-1 rounded-full bg-for mx-auto transition-all duration-300 ease-in-out transform scale-x-0 group-hover:scale-x-100 origin-center absolute left-1/2 transform -translate-x-1/2"
      ...
      <div
        id="mobile_men"
        class="hidden fixed bg-white z-10 md:hidden inset-0 p-3"
      >
        <div id="nav-bar" class="flex justify-between">
          <a
            href="#"
            id="brands"
            class="font-Nrj-fonts font-bold text-lg flex items-center ml-2"
          >
            <img
              class="object-cover max-w-18 max-h-18"
              src="../assets/img/stayease logo.svg"
              alt="Logo"
            />
          </a>
        ...
        <div class="mt-5">
          <a
            href="#"
            class="font-Nrj-fonts font-semibold m-3 p-3 hover:bg-gray-100 hover:text-primary rounded-lg block"
            >Home</a
          >
          <a
            href="#"
    ...
    <div
      class="absolute top-0 left-0 right-0 bottom-0 z-0 flex justify-center items-start"
    >
      <img
      class="hidden md:block md:w-[1550px] w-full mt-0"
        src="../assets/img/relaxing-with-headphones.png"
    ...
    <!-- Intro Para -->
    <div
      class="relative mt-32 flex justify-center items-center text-center flex-col"
    >
  ...
  <!-- Featured features -->
      ...
      >
        <h1
          class="font-Nrj-fonts font-semibold text-black text-lg mt-[30px] text-center"
        >
    ...
    <h1
      class="font-Nrj-fonts font-semibold text-2xl md:text-4xl lg:text-4xl mt-12  leading-snug text-center"
    >
    ...
    <div class="flex flex-row items-center mt-24 justify-evenly ">
      <ol class="ml-12 relative text-gray-500 border-s-[3px] border-gray-200 dark:border-gray-700 dark:text-gray-400 font-Nrj-fonts text-lg">
      ...
      <div class="flex justify-center items-center scroll-animation">
        ...
        <div class="w-32 h-32 md:w-72 md:h-72 lg:w-72 lg:h-72 bg-for bg-opacity-90 rounded-full relative">
          <!-- Image -->
          <img src="../assets/img/finger-pointing.png" alt="Finger Pointing" class="max-w-90 max-h-90 -mt-12 md:-mt-9 lg:-mt-[107px] " />
        </div>
      </div>
    </div>

    <h1
      class="font-Nrj-fonts font-medium text-2xl md:text-lg lg:text-lg mt-24  leading-snug text-center"
    >
    Curated
    especially
    for you<br />
    ...
    <!-- Property Cards -->
    <div id="property-card" class="flex justify-evenly items-center flex-col gap-8 md:gap-0 lg:gap-0 md:flex-row lg:flex-row mt-6 font-Nrj-fonts">
      <div class="w-72 bg-white border border-gray-300 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
        ...
        <div class="px-4 py-2">
          <!-- Type Badge -->
          <div id="property-type-container" class="flex flex-row justify-center items-center w-24 h-6 bg-gray-200 rounded-sm">
          ...
          <p
            ...
            class="text-sm font-normal text-gray-600 dark:text-gray-400 flex items-center"
          >
            Bicholim-Goa
          </p>
          <!-- Rent and View Link -->
          <div id="property-details" class="flex flex-row items-center justify-between mt-2">
            <p
              id="property-rent"
              class="text-lg font-semibold font-Nrj-fonts text-black"
            >
              <span class="text-sm font-normal">from</span> ₹15,000/
              <span class="text-sm font-normal">month</span>
            </p>
            <a
              id="view-details-link"
              class="font-Nrj-fonts font-normal text-for hover:underline"
    ...
    <!-- Testimonials -->
    <div
      class="mt-72 md:mt-12 lg:mt-12 w-full h-96 to-transparent flex justify-center items-center flex-col"
    >
      <div class="">
        ...
        <section class="pb-2 mt-12 mx-auto md:pb-1 max-w-7xl font-Nrj-fonts">
          <div class="gap-8 space-y-8 md:columns-2 lg:columns-3">
            <div
              class="p-8 bg-white border border-gray-300 drop-shadow-md aspect-auto rounded-xl shadow-gray-600/10"
            >
    ...
    <div class="flex flex-col items-center mt-64 md:mt-12 lg:mt-12 mb-1"> <!-- Further reduced mt-10 to mt-6 and mb-2 to mb-1 -->
        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 mt-6 gap-8 items-start">
            ...
            <div class="group cursor-pointer rounded-xl border border-gray-200 bg-gray-50 p-6">
                ...
                <dd id="faq-3" class="hidden text-sm font-Nrj-fonts font-normal mt-6">
                    <p>Yes, a small booking fee may apply when reserving a room, which will be displayed before you confirm your booking.</p>
                </dd>
            </div>
            <div class="group rounded-xl border border-gray-200 bg-gray-50 p-6">
                <dt class="cursor-pointer flex justify-between items-center" aria-controls="faq-4">
                    <p class="font-semibold text-sm font-Nrj-fonts" >Can I communicate with landlords?</p>                        </p>
                    <i class="fa-solid fa-caret-down  transition-transform"></i>
                </dt>
            ...
            <div class="group cursor-pointer rounded-xl border border-gray-200 bg-gray-50 p-6">
                ...
                <dd id="faq-5" class="hidden text-sm font-Nrj-fonts font-normal mt-6">
                    <p>Payments are securely processed through Stripe, allowing for various payment methods, including credit and debit cards.</p>
                </dd>
            </div>
            <div class="group cursor-pointer rounded-xl border border-gray-200 bg-gray-50 p-6">
                ...
                <dd id="faq-6" class="hidden text-sm font-Nrj-fonts font-normal mt-6">
                    <p>Amenities vary by listing, but many include Wi-Fi, laundry facilities, and kitchen access. Check individual listings for details.</p>
                </dd>
            </div>
        </div>
    </div>
    ...
    <footer class="bg-black font-Nrj-fonts ">
      <div class="mx-auto w-full max-w-screen-xl p-4 py-6 lg:py-8">
        ...
        <div class="sm:flex sm:items-center sm:justify-between">
            <span class="text-sm text-white sm:text-center dark:text-gray-400">© 2025 <a href="#" class="hover:underline">StayEase™</a>. All Rights Reserved.
            </span>
